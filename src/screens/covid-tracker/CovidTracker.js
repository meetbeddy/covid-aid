...
const App = () => {
  const [country, setInputCountry] = useState("Nigeria");
  ...
  return (
    <div className="app" id="covid-tracker">
      <div className="app__left">
        ...
        <div className="app__stats">
          <InfoBox
            ...
            cases={prettyPrintStat(countryInfo.totalConfirmedCases)}
          ...
          <InfoBox
            ...
            cases={prettyPrintStat(countryInfo.discharged)}
          ...
          <InfoBox
            ...
            cases={prettyPrintStat(countryInfo.death)}
